...
import { checkLogin, setUserLogin } from "../../helper.js"; //User Action for Redux Store
...
class Login extends Component {
  state = {
    ...
    toDashboard: false,
    toRegister: false,
  }; //Keeping track of redirects, errors, inputs from user
  constructor() {
    super();
  ...
  handleLoginSubmit = (e) => {
    ...
    //This is an async function in helper.js that will redirect user to dashboard once user is logged in and call is complete
    setUserLogin(this.state, this.refs.rememberUsr.checked)
      .then(() => {
        this.setState({ toDashboard: true }); //Set redirect flag
      })
      .catch((error) => {
