...
import { faEdit, faTrash, faCheck } from "@fortawesome/free-solid-svg-icons"; //For nice buttons
...
class SessionCard extends Component {
  ...
  //The folowing are all only rendered when the user is editing a session. Since it would have been messy code in if statements in render(), they are seperate funcs. Much easier to read
  buildDateEditField() {
    return (
      <DatePicker //I chose a datepicker component as it was the most user friendly way to pick dates and the react-datepicker package is super well done already.
        ...
        showTimeSelect
        timeFormat="hh:mm a" //12 hour time, We don't do military time in this IDE
        timeIntervals={15}
        timeCaption="time"
